      ...
      <View className="w-4/5 items-center">
        ...
        <View className="mt-4 w-full">
          ...
          <View className="mb-3">
            ...
            <TextInput className="border border-theme-green rounded p-2" placeholder="samanamarasinghe@email.com" placeholderTextColor="#AAA" />
          </View>
          <View className="mb-3">
          ...
          <TouchableOpacity onPress={() => navigation.navigate('(sign_up_data)')} className="bg-theme-green p-2 mt-3 mb-5 mx-20 rounded-full justify-center items-center"> 
